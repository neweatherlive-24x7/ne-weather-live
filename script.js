...
const layers = [
   ...
   {count:3,speed:0.35,opacity:0.15,scale:1.8},
{count:4,speed:0.65,opacity:0.24,scale:1.2},
{count:3,speed:1.00,opacity:0.30,scale:0.9}
...
function drawClouds(){
    ...
    weatherContext.filter = "blur(4px)";
...
span.style.animation = "tickerMove 9s linear infinite";
