...
function updateForecast() {
    ...
    const forecast =
        forecastDatabase[featured.name];
...
function updateTicker() {
    ...
    messages.push(
        ...
        "📺 NE WEATHER LIVE • 24×7 • Powered by Open-Meteo"
...
span.style.animation = "tickerMove 28s linear infinite";
